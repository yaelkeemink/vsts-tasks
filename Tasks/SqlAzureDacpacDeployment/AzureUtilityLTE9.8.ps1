...
function Create-AzureSqlDatabaseServerFirewallRuleARM
{
    ...
    $azureSqlDatabaseServerFirewallRule = New-AzureSqlServerFirewallRule -ResourceGroupName $azureResourceGroupName -StartIPAddress $startIPAddress -EndIPAddress $endIPAddress -ServerName $serverName -FirewallRuleName $firewallRuleName -ErrorAction Stop | Out-Null
