...
function Substitute-ConfigurationParameters
{
    ...
    Write-Verbose "Package file for parameters substitution : $PackageFile" -Verbose
...
function Get-7ZipExeLocation
{
    ...
    {
        #7Zip.exe file at location $7ZipExeFileLocation doesn't exists.
        #throw (Get-VstsLocString -Key "7Zipexefileatlocation0doesntexists" -ArgumentList $7ZipExeFileLocation)
...
Substitute-ConfigurationParameters "E:\test7zip\WebAppWebJob1.zip"